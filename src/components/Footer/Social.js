...
const style = {
  ...
  social:
    "text-gray-100 text-xl md:text-xl hover:mx-4 transition-all duration-[300ms] cursor-pointer",
};
const Social = () => {
  return (
    <div className={style.wrapper}>
      <a
        ...
        target="_black"
        href="https://www.facebook.com/DressEcode1/"
      >
        <BsFacebook />
      </a>
      <a
        ...
        className={style.social}
        target="_black"
        href="https://www.instagram.com/dress_ecode/"
      >
        <BsInstagram />
      </a>
      {/* <a
